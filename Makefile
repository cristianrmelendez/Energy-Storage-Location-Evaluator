...
SOURCES = \
	__init__.py \
	energy_storage_location_evaluator.py 

PLUGINNAME = energy_storage_location_evaluator
...
QGISDIR=/Users/cristianmelendez/Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins
